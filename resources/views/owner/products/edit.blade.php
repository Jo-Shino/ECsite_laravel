                            ...
                            <div class="-m-2">
                                    ...
                                    @foreach($categories as $category)
                                      <optgroup label="{{$category->name}}">
                                        @foreach($category->secondary as $secondary)
                                          <option value="{{$secondary->id}}" @if($secondary->id === $product->secondary_category_id) seleceted @endif>
                                            {{$secondary->name}}
                                          </option>
                                        @endforeach
                                    @endforeach
                              ...
                              <div class="p-2 w-1/2　mx-auto">
                                <div class="relative flex justify-around">
                                  ...
                                  <div><input type="radio" name="is_selling" value="1" class="mr-2" @if($product->is_selling === 0){ checked } @endif>停止中</div>
                                </div>
                              </div>
